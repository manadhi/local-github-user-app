...
import com.udhipe.favoriteuserreader.databinding.FragmentFollowBinding
        ...
        if (index != null) {
            ...
            userViewModel.getInfo(index).observe(viewLifecycleOwner, {
                when (it) {
                    ...
                    null, "", UserDetailViewModel.DATA_EMPTY -> {
    ...
    private fun setAdapter() {
        val onItemCallBack = object : UserAdapter.OnItemClickCallback {
            override fun onItemClick(userName: String) {
                ...
                intent.putExtra(UserFavoriteActivity.USERNAME, userName)
